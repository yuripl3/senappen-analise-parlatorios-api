...
// The hash below is bcrypt(12 rounds) of that password.
...
export const MOCK_USERS: MockUser[] = [
  {
    ...
    passwordHash: '$2b$12$LG.Znlyfhx.aB5g9jXXyQOVXrwWoRZ5hWdnOMCmhSG/r13W5yB2lO',
    role: UserRole.admin,
    units: [],
    active: true,
...
export const MOCK_RECORDS: MockRecord[] = [
    ...
    userComments: [
      {
        lineIndex: 3,
        tagged: true,
        comment: 'Trecho suspeito — "encomenda" pode ser código para entrega de material ilícito.',
      },
      {
        lineIndex: 5,
        tagged: true,
        comment: 'Confirmação implícita de recebimento com linguagem codificada.',
      },
    ],
    archivedAt: null,
    archivedById: null,
  ...
  },
  {
    ...
    unit: 'Penitenciária I de Hortolândia',
    vivencia: 'Delta',
    equipment: 'Mono',
    blobUrl: null,
    mediaAvailable: true,
